...
$query=mysqli_query($db,"insert into users(name,email,contactno,password) 
...
$email=$_POST['email']; 
$password=md5($_POST['password']); 
$query=mysqli_query($db,"SELECT * FROM users WHERE email='$email' and 
password='$password'"); 
...
$status=1; 
$log=mysqli_query($db,"insert into userlog(userEmail,userip,status) 
...
<title>Public Webservice | Signi-in | Signup</title> 
<!-- Bootstrap Core CSS --> 
